...
export const UI_THEMES: UITheme[] = [
    { h: 0,  backgroundColor: '#0f0f2a', borderColor: '#2a2a4a', textColor: '#c8d8ff', sunColor: '#4a4aaa', },
    { h: 4,  backgroundColor: '#120d30', borderColor: '#2f2555', textColor: '#c8d8ff', sunColor: '#5040b0', },
    { h: 5,  backgroundColor: '#1e0d30', borderColor: '#502070', textColor: '#ffcfef', sunColor: '#a040a0', },
    { h: 6,  backgroundColor: '#2a1020', borderColor: '#702040', textColor: '#ffe8d0', sunColor: '#d05060' },
    { h: 7,  backgroundColor: '#3a1a30', borderColor: '#8a4a60', textColor: '#fff0e0', sunColor: '#ff7040' },
    { h: 8,  backgroundColor: '#d0e8f8', borderColor: '#90c0e0', textColor: '#1a3a5a', sunColor: '#f0c040' },
    { h: 10, backgroundColor: '#c8e0f5', borderColor: '#80b0d0', textColor: '#0a2a4a', sunColor: '#f5c830' },
    { h: 12, backgroundColor: '#c0d8f0', borderColor: '#70a8c8', textColor: '#082040', sunColor: '#fad020' },
    { h: 15, backgroundColor: '#c8e0f5', borderColor: '#80b0d0', textColor: '#0a2a4a', sunColor: '#f5c030' },
    { h: 17, backgroundColor: '#d8d0f0', borderColor: '#b090d0', textColor: '#2a1a4a', sunColor: '#e09040' },
    { h: 18, backgroundColor: '#2a1015', borderColor: '#803040', textColor: '#ffd0c0', sunColor: '#e06030' },
    { h: 19, backgroundColor: '#200818', borderColor: '#602040', textColor: '#ffc0d8', sunColor: '#c03060' },
    { h: 20, backgroundColor: '#150810', borderColor: '#401840', textColor: '#d0c0ff', sunColor: '#7030a0' },
    { h: 21, backgroundColor: '#0d0810', borderColor: '#2a1838', textColor: '#c0c8ff', sunColor: '#5040a0' },
    { h: 23, backgroundColor: '#0f0f2a', borderColor: '#2a2a4a', textColor: '#c8d8ff', sunColor: '#4a4aaa' },
];